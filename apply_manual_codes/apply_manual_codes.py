...
if __name__ == "__main__":
    ...
    merge_plan = [
        MergePlan("Message - Aisha", "Aisha", "Message - Aisha_Coded", "Dadaab Themes"),
        MergePlan("Message - Amina", "Amina", "Message - Amina_Coded", "Dadaab Themes"),
        MergePlan("Message - Mohamed", "Mohamed", "Message - Mohamed_Coded", "Dadaab Themes"),
        MergePlan("Message - Zamzam", "Zamzam", "Message - Zamzam_Coded", "Dadaab Themes"),

        MergePlan("Selected_Gender - Demog_survey", "Demogs_Gender", "Gender - Demog_survey_Coded", "Gender"),
        MergePlan("Selected_Age - Demog_survey", "Demogs_Age", "Age - Demog_survey_Coded", "Age"),
        MergePlan("Selected_Location - Demog_survey", "Demogs_Locations", "Location - Demog_survey_Coded", "Location"),

        MergePlan("Selected_Empirical_Expectations - Aisha_survey", "Aisha_Empirical_Expectations", "Empirical_Expectations - Aisha_survey_Coded", "Empirical Expectations"),
        MergePlan("Selected_Empirical_Expectations - Amina_survey", "Amina_Empirical_Expectations", "Empirical_Expectations - Amina_survey_Coded", "Empirical Expectations"),
        MergePlan("Selected_Empirical_Expectations - Mohamed_survey", "Mohamed_Empirical_Expectations", "Empirical_Expectations - Mohamed_survey_Coded", "Empirical Expectations"),
        MergePlan("Selected_Empirical_Expectations - Zamzam_survey", "Zamzam_Empirical_Expectations", "Empirical_Expectations - Zamzam_survey_Coded", "Empirical Expectations"),

        MergePlan("Selected_Normative_Expectations - Aisha_survey", "Aisha_Normative_Expectations", "Normative_Expectations - Aisha_survey_Coded", "Normative Expectations"),
        MergePlan("Selected_Normative_Expectations - Amina_survey", "Amina_Normative_Expectations", "Normative_Expectations - Amina_survey_Coded", "Normative Expectations"),
        MergePlan("Selected_Normative_Expectations - Mohamed_survey", "Mohamed_Normative_Expectations", "Normative_Expectations - Mohamed_survey_Coded", "Normative Expectations"),
        MergePlan("Selected_Normative_Expectations - Zamzam_survey", "Zamzam_Normative_Expectations", "Normative_Expectations - Zamzam_survey_Coded", "Normative Expectations"),

        MergePlan("Selected_Parenthood - Aisha_survey", "Aisha_Parenthood", "Parenthood - Aisha_survey_Coded", "NoYes"),
        MergePlan("Selected_Parenthood - Amina_survey", "Amina_Parenthood", "Parenthood - Amina_survey_Coded", "NoYes"),
        MergePlan("Selected_Parenthood - Mohamed_survey", "Mohamed_Parenthood", "Parenthood - Mohamed_survey_Coded", "NoYes"),
        MergePlan("Selected_Parenthood - Zamzam_survey", "Zamzam_Parenthood", "Parenthood - Zamzam_survey_Coded", "NoYes"),
        
        MergePlan("Selected_Reference_Groups - Aisha_survey", "Aisha_Reference_Groups", "Reference_Groups - Aisha_survey_Coded", "Reference group and Reference Group Others"),
        MergePlan("Selected_Reference_Groups - Amina_survey", "Amina_Reference_Groups", "Reference_Groups - Amina_survey_Coded", "Reference group and Reference Group Others"),
        MergePlan("Selected_Reference_Groups - Mohamed_survey", "Mohamed_Reference_Groups", "Reference_Groups - Mohamed_survey_Coded", "Reference group and Reference Group Others"),
        MergePlan("Selected_Reference_Groups - Zamzam_survey", "Zamzam_Reference_Groups", "Reference_Groups - Zamzam_survey_Coded", "Reference group and Reference Group Others"),

        MergePlan("Selected_Reference_Groups_Others - Aisha_survey", "Aisha_Reference_Groups_Others", "Reference_Groups_Others - Aisha_survey_Coded", "Reference group and Reference Group Others"),
        MergePlan("Selected_Reference_Groups_Others - Amina_survey", "Amina_Reference_Groups_Others", "Reference_Groups_Others - Amina_survey_Coded", "Reference group and Reference Group Others"),
        MergePlan("Selected_Reference_Groups_Others - Mohamed_survey", "Mohamed_Reference_Groups_Others", "Reference_Groups_Others - Mohamed_survey_Coded", "Reference group and Reference Group Others"),
        MergePlan("Selected_Reference_Groups_Others - Zamzam_survey", "Zamzam_Reference_Groups_Others", "Reference_Groups_Others - Zamzam_survey_Coded", "Reference group and Reference Group Others"),

        MergePlan("Selected_Sanctions - Aisha_survey", "Aisha_Sanctions", "Sanctions - Aisha_survey_Coded", "Approval"),
        MergePlan("Selected_Sanctions - Amina_survey", "Amina_Sanctions", "Sanctions - Amina_survey_Coded", "Approval"),
        MergePlan("Selected_Sanctions - Mohamed_survey", "Mohamed_Sanctions", "Sanctions - Mohamed_survey_Coded", "Approval"),
        MergePlan("Selected_Sanctions - Zamzam_survey", "Zamzam_Sanctions", "Sanctions - Zamzam_survey_Coded", "Approval"),
    ]
